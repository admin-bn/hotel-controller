...
public class ProofServiceImpl implements ProofService {
    ...
    private @Value("${ssibk.hotel.controller.agent.corporateid.schema_ids}") String corporateIdSchemaIdsString;
    private @Value("${ssibk.hotel.controller.agent.corporateid.issuer_dids}") String corporateIdIssuerDidsString;
    ...
    public URI getProofURI(String hotelId, String deskId) {
        ...
        ProofResponseDTO proofResponseDTO = this.acapyClient.createProofRequest(apikey,
        ...
        ConnectionlessProofRequest connectionlessProofRequest = this
                .prepareConnectionlessProofRequest(proofResponseDTO);
    ...
    private ProofRequestDTO prepareConnectionlessProofRequest() {
        ...
        this.addCorporateIdAttributes(requestedAttributes);
    ...
    private void addMasterIdAttributes(RequestedAttributes requestedAttributes) {
        ...
        List<String> names = Arrays.asList("firstName", "familyName", "addressStreet", "addressZipCode", "addressCountry", "addressCity", "dateOfExpiry", "dateOfBirth");
    ...
    private void addCorporateIdAttributes(RequestedAttributes requestedAttributes) {
        ...
        List<Map<String, String>> corporateIdRestrictions = new ArrayList<Map<String, String>>();
        ...
        requestedAttributes.setCorporateId(proofRequestCorporateId);
    }
    ...
    public void handleProofWebhook(WebhookPresentProofDTO webhookPresentProofDTO) {
        ...
        if (webhookPresentProofDTO.getState().equals("verified")) {
            ...
            try {
                CheckInCredential checkInCredential = this.checkInCredentialService.updateValidity(presentationExchangeId,
                        proofVerified);
