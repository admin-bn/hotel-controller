...
public class RequestedAttributes {
    ...
    private ProofRequestProperty corporateId;
    ...
    public void setCorporateId(ProofRequestProperty corporateId) {
...
/**
    ...
    private void unpackNested(Map<String,Object> requested_attributes) {
        this.additionalProp1 = (String)requested_attributes.get("additionalProp1");
        this.name = additionalProp1.get("name");
